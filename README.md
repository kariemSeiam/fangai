...
**Implementation root:** this repository ([`kariemSeiam/fangai`](https://github.com/kariemSeiam/fangai)) is the **pnpm workspace** for `@fangai/*`. Product **spec, roadmap, and ADRs:** [`spec/README.md`](spec/README.md). **Technical docs:** [`ARCHITECTURE.md`](ARCHITECTURE.md), [`docs/FANG-SPEC.md`](docs/FANG-SPEC.md).
...
```
repo root               # pnpm workspace in github.com/kariemSeiam/fangai (npm: @fangai/*)
├── packages/
│   ├── core/               ← @fangai/core
